...
ADMINS = [("""Hoan Tran""", "hoan-tran@example.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Django Templateull 2023 API",
    "DESCRIPTION": "Documentation of API endpoints of Django Templateull 2023",
    "VERSION": "1.0.0",
    # "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
}

# dj-rest-auth - https://dj-rest-auth.readthedocs.io/en/latest/installation.html#settings
REST_AUTH = {
    "USE_JWT": True,
}
